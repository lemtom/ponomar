 ...
 * FILES.
 * 
 * ConfigurationFiles.java is part of the Ponomar project. Copyright 2008, 2013
 * Yuri Shardt version 1.0: August 2008 version 2.0: January 2013 yuri.shardt
 * (at) gmail.com
 * 
...
public class ConfigurationFiles implements DocHandler {
	protected static Map<Object, Object> Defaults; // STORES THE START-UP VALUES FOR PONOMAR

	// THIS ALLOWS THE PONOMAR CONFIGURAITON FILE TO BE MAINTAINED, UPDATED, AND
	// READ.
	...
	public static void ReadFile() {
		...
		try {
			...
			BufferedReader frf = new BufferedReader(new InputStreamReader(
					Files.newInputStream(Paths.get("Ponomar/languages/xml/ponomar.config")), StandardCharsets.UTF_8));
	...
	public static void WriteFile() {
		...
		try {
			BufferedWriter out = new BufferedWriter(new OutputStreamWriter(
					Files.newOutputStream(Paths.get("Ponomar/languages/xml/ponomar.config")), StandardCharsets.UTF_8));
			// BufferedWriter out = new BufferedWriter(new
			// FileWriter("Ponomar/xml/ponomar.config"));//,"UT8");
			out.write("<CONFIGURATION>");
			out.newLine();
			output = new StringBuilder("<DEFAULT ");
			for (Object i : Defaults.keySet()) {
				String key = (String) i;
