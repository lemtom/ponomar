...
public class NinthHour implements DocHandler, ActionListener, ItemListener, PropertyChangeListener
{
	...
	private String[] PrimesNames;//=Text.obtainValues((String)Text.Phrases.get("None"));
		...
		if(Type.equals("Lenten"))
	       {
	       		...
	       		if(LentenK != null)
	       		{
	       			...
	       			BufferedWriter out = new BufferedWriter(new OutputStreamWriter(Files.newOutputStream(Paths.get("Ponomar/languages/" + Analyse.dayInfo.get("LS").toString() + ServicesFileName + "Var/PKath9.xml")), StandardCharsets.UTF_8));
			...
			if(Troparion1 != null)
	    		{
	    		    	if(Troparion2 != null)
	    		    	{
	    		    		BufferedWriter out = new BufferedWriter(new OutputStreamWriter(Files.newOutputStream(Paths.get("Ponomar/languages/" + Analyse.dayInfo.get("LS").toString() + ServicesFileName + "Var/PTrop91.xml")), StandardCharsets.UTF_8));
	    				String Data="<SERVICES>\r\n<LANGUAGE>\r\n<CREATE Who=\"\" What=\"TROPARION/"+Troparion1+"\" Header=\"1\" RedFirst=\"1\" NewLine=\"1\"/>\r\n</LANGUAGE>\r\n</SERVICES>";
	    				out.write(Data);
	    				out.close();
	    				
	    				out = new BufferedWriter(new OutputStreamWriter(Files.newOutputStream(Paths.get("Ponomar/languages/" + Analyse.dayInfo.get("LS").toString() + ServicesFileName + "Var/PTrop92.xml")), StandardCharsets.UTF_8));
	    				Data="<SERVICES>\r\n<LANGUAGE>\r\n<CREATE Who=\"\" What=\"TROPARION/"+Troparion2+"\" Header=\"1\" RedFirst=\"1\" NewLine=\"1\"/>\r\n</LANGUAGE>\r\n</SERVICES>";
	    				out.write(Data);
	    				out.close();
					
	    		    	}
    	     			BufferedWriter out = new BufferedWriter(new OutputStreamWriter(Files.newOutputStream(Paths.get("Ponomar/languages/" + Analyse.dayInfo.get("LS").toString() + ServicesFileName + "Var/PTrop92.xml")), StandardCharsets.UTF_8));
	    			String Data="<SERVICES>\r\n<LANGUAGE>\r\n<CREATE Who=\"\" What=\"TROPARION/"+Troparion1+"\" Header=\"1\" RedFirst=\"1\" NewLine=\"1\"/>\r\n</LANGUAGE>\r\n</SERVICES>";
	    			out.write(Data);
	    			out.close();
    	     		}
	       	...
	       	if (Kontakion1 != null)
		{
			BufferedWriter out = new BufferedWriter(new OutputStreamWriter(Files.newOutputStream(Paths.get("Ponomar/languages/" + Analyse.dayInfo.get("LS").toString() + ServicesFileName + "Var/PKont9.xml")), StandardCharsets.UTF_8));
