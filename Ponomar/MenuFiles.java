...
class MenuFiles extends JMenu implements ItemListener, PropertyChangeListener {
	...
	private JMenuItem menuItem, menu3Item, menu4Item, menu5Item, menu6Item, menu7Item, menu8Item, menu9Item, menu10Item,
			menu11Item, menu12Item, menu13Item, menu14Item, menu15Item, menu16Item, menu17Item;
	...
	private final String[] editComm;
	private final String[] editPrayers;
	...
	public JMenu createOptionsMenu(PropertyChangeListener pl, ActionListener al) {
		...
		LanguageSelection = new LanguageSelector(new LinkedHashMap<>(analyse.dayInfo));
		JMenu selection2 = LanguageSelection.createLanguageMenu(new LinkedHashMap<>(analyse.dayInfo));
